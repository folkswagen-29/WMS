<%@ Page Title="Litigation Edit" Async="true" Language="C#" MasterPageFile="~/frmInsurance/SiteLigalWorkFlow.Master" AutoEventWireup="true" CodeBehind="LitigationRequestEdit.aspx.cs" Inherits="WMS.frmLitigation.LitigationRequestEdit" %>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="div_90">
                    <asp:Table ID="Table1" runat="server">
                        ...
                        <asp:TableRow ID="pro_occ_section" runat="server" Visible="false">
                            ...
                            <asp:TableCell>&nbsp;</asp:TableCell>
                            <asp:TableCell CssClass="cell_content_80PC_TL">
                                <asp:TextBox ID="pro_occ_desc" runat="server" CssClass="Text_600" TextMode="MultiLine" Height="100px"></asp:TextBox>
                            </asp:TableCell>
                            <asp:TableCell>&nbsp;</asp:TableCell>
                        </asp:TableRow>
