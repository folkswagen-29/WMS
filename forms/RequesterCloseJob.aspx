<%@ Page Title="Close Job" Async="true" Language="C#" MasterPageFile="~/frmInsurance/SiteLigalWorkFlow.Master" AutoEventWireup="true" CodeBehind="RequesterCloseJob.aspx.cs" Inherits="WMS.forms.RequesterCloseJob" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="cell_content_100PC" style="font-family: Tahoma;">
        ...
        <tr class="cell_content_100PC">
            <td colspan="2" class="cell_content_100PC">
                <asp:Button ID="btn_Submit" runat="server" CssClass="btn_normal_blue" Text="Submit" OnClick="btn_Submit_Click" OnClientClick="this.disabled = true;" UseSubmitBehavior="false" />
