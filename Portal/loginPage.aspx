<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginPage.aspx.cs" Inherits="WMS.Portal.loginPage" %>
                    ...
                    <td>
                        <asp:Panel ID="Panel1" runat="server" Height="600px" Width="600px">
                            <table cellpadding="0" cellspacing="0" class="auto-style1">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:Label ID="Label1" runat="server" Font-Names="tahoma" Font-Size="12pt" ForeColor="#990000" Text="Warehouse Management System"></asp:Label>
                                    </td>
                                </tr>
                                <%--<tr>
                                    <td colspan="4">
