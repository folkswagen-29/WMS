<%@ Page Title="Commercial Registration Request Admin Edit" Async="true" Language="C#" MasterPageFile="~/frmInsurance/SiteLigalWorkFlow.Master" AutoEventWireup="true" CodeBehind="CommRegisRequestEditByAdmin.aspx.cs" Inherits="onlineLegalWF.frmCommregis.CommRegisRequestEditByAdmin" %>
                                ...
                                <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="False" CellPadding="4" Font-Names="Tahoma" Font-Size="9pt" ForeColor="#333333" GridLines="None" OnRowCommand="gv_RowCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ผู้รับผิดชอบ">
                                            <ItemTemplate>
                                                <asp:Label ID="gv1txtassto_login" Text='<%# Bind("assto_login") %>' runat="server" CssClass="Text_sm"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="100px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="สถานะ">
                                            <ItemTemplate>
                                                <asp:Label ID="gv1txtstatus" Text='<%# Bind("status") %>' runat="server" CssClass="Text_sm"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="100px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="วันที่ทำรายการ">
                                            <ItemTemplate>
                                                <asp:TextBox ID="gv1txtcreated_datetime" Text='<%# Bind("created_datetime") %>' TextMode="Date" runat="server" Enabled="false" CssClass="Text_sm"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle Width="100px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="วันที่แก้ไขล่าสุด">
                                            <ItemTemplate>
                                                <asp:TextBox ID="gv1txtupdated_datetime" Text='<%# Bind("updated_datetime") %>' TextMode="Date" runat="server" Enabled="false" CssClass="Text_sm"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle Width="100px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="gvIbtnEdit" runat="server" Height="20px" ImageUrl="~/images/icon_edit.png" CommandArgument="<%# Container.DataItemIndex %>" CommandName="openModal" />
                                            </ItemTemplate>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="font-size: 10pt; font-family: tahoma;">
                    ...
                    <asp:HiddenField ID="md_subsidiary_code" runat="server" />
                    <table>
                        <tr>
                            <td class="cell_content_20PC_TR">
                            ...
                            <td class="cell_content_80PC_TL">
                                <asp:RadioButtonList ID="rdlAction" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="wait assign" Selected="True">Wait Assign</asp:ListItem>
