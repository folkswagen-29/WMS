...
<asp:Panel ID="Panel1" runat="server" CssClass="div_90">
    <table cellpadding="0" cellspacing="0" class="w-100">
        ...
        <tr>
            <td colspan="3">
                <div>
                    <asp:GridView ID="commentGV" UseAccessibleHeader="true" runat="server" CssClass="table w-100" GridLines="None" AutoGenerateColumns="false" EmptyDataText="No Comment Logs">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
