<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsuranceRenewRequestEdit.aspx.cs" Inherits="onlineLegalWF.frmInsurance.InsuranceRenewRequestEdit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>InsuranceRenewRequestEdit</title>
    <style type="text/css">
        .auto-style1 {
            width: 1000px;
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="company_name" runat="server" />
